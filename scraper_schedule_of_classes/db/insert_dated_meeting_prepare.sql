...
Parameters:
    ...
    $8: date
*/
PREPARE insert_dated_meetings (integer, text, text, time, time, text, text, text) AS
    ...
    INSERT INTO dated_meeting (meeting_id, date_)
        VALUES ((SELECT * FROM insert_meeting_get_id), $8)